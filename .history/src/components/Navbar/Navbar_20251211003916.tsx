...
<nav className={clsx(
  ...
  "bg-white dark:bg-darkNavy " ,"transition-all duration-200 ease-in-out","w-full")}>
      <div className="flex justify-between items-center w-full">
        ...
        {/* Mobile menu with animation */}
          ...
          {menuOpen && (
            <ul  className={clsx("flex flex-col gap-5 justify-center items-center z-51 md:hidden",
                "text-lg leading-6","fixed inset-0 h-screen w-screen","bg-white dark:bg-darkNavy ")} >
              {/* Logo/Title*/}
              <li  className="font-semibold text-lg leading-6 md:hidden"> Your Name</li>
        ...
        <button className="md:hidden z-50" onClick={() => setMenuOpen(true)} aria-label="Open menu">
          <img src="/theblog/images/navbar/bars.svg" alt="Menu" className="dark:filter dark:invert"/>
        </button>
